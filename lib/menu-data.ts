...
export const menuSections: MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "G", name: "Popcorn Chicken", price: "$5.25 / $7.95 / $8.95 / $9.99" },
      ...
      { id: "L", name: "Spare Rib Tips", price: "$6.25 / $8.25 / $9.25 / $10.25" },
      { id: "M", name: "Pork Butt", price: "$6.25 / $8.25 / $9.25 / $10.25" },
      { id: "N", name: "Chicken Nuggets (10)", price: "$5.95 / $7.95 / $8.95 / $9.99" },
      { id: "O", name: "Chicken Gizzards", price: "$5.25 / $7.95 / $8.95 / $9.99" },
      { id: "P", name: "Boneless Spare Ribs", price: "Sm $8.75 / Lg $13.95" },
      { id: "Q", name: "Bar-B-Q Spare Ribs", price: "Sm $8.75 / Lg $13.95" },
    ],
  },
  {
    id: "beef",
