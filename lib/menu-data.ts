...
export const menuSections: MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      { id: "A", name: "Honey Chicken Wings (8 pcs)", price: "$7.35" },
      { id: "B", name: "Fried Chicken Wings (4 Whole)", price: "$6.50" },
      { id: "C", name: "Wings w. General Tso's Sauce", price: "$7.35" },
      { id: "D", name: "B-B-Q Wings (8 pcs)", price: "$7.35" },
      { id: "E", name: "Wings w. Garlic Sauce", price: "$7.35" },
      { id: "F", name: "Chicken Fingers (4)", price: "$6.25" },
